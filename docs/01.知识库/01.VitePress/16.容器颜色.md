# 容器颜色
:::tip
本文转载至[VitePress快速上手中文教程](https://vitepress.yiov.top/style#%E5%AE%B9%E5%99%A8%E9%A2%9C%E8%89%B2)
:::

随着版本更新迭代，现在这`tip``warning``danger`颜色真的想吐槽，好丑！

`Vuepress/hope`主题的容器颜色 就不错，参考着弄一下
...
```
打开`.vitepress/theme/index.js`，在顶部已有的`import`后面再加一行。
```ts
// 原来已有的
